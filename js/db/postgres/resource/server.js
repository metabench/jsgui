...
define(["../../../core/jsgui-lang-enh", 'pg', '../abstract/core/all', '../../../resource/core/resource', '../dbi-postgres'],
function(jsgui, pg, Abstract, Resource, DBI_Postgres) {

*/

var jsgui = require('../../../core/jsgui-lang-enh'), pg = require('pg'), Abstract = require('../abstract/core/all'), Resource = require('../../../resource/core/resource'), DBI_Postgres = require('../dbi-postgres');
...
//});
module.exports = Postgres_Server;
