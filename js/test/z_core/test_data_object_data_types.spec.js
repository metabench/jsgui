...
requirejs(['../../core/jsgui-lang-util'],
*/
...
function (jsgui, assert, test_utils) {
	...
	describe("z_core /test_data_object_data_types.spec.js ", function() {
		...
		xit("test_Color", function() {
		
			var test_Color = function() {
		...
		it("test_optional_array", function() {
			...
			var test_optional_array = function() {
		...
		it("test_optional_array_distance", function() {
			...
			var test_optional_array_distance = function() {
		...
		xit("test_indexed_array", function() {
		
			var test_indexed_array = function() {
		...
		it("test_indexed_array_distance", function() {
			...
			var test_indexed_array_distance = function() {
		...
		xit("test_oltrb", function() {
				
			/*
			var test_oltrb = function() {
