...
requirejs(['./jsgui-server', 'express', './jsgui-sample-controls', './express_admin_routines'],
function (jsgui, express, jsgui_sample_controls, e_a_r) {
	...
	server.start(port, function() {
		...
		// And use Express Admin Routines.
