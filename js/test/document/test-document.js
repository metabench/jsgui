...
requirejs(['../../web/jsgui-server', 'express', '../../web/controls/jsgui-sample-controls', '../../web/controls/basic/radio-button', '../../fs/jsgui-node-fs2-core', 'uglify-js', 'zlib', './test-document-client'],
