...
// Should maybe extend HTML docuument controls.
//  HTML Documents I think are pages basically.
//  And it's clearer where they fit into the HTML stack.

// A document control that contains the mult-mode layout seems useful.
//  It could be rendered for a variety of displays / devices.
//   On the server, would already have an idea about what to render
//   However, in many cases, CSS changes would cover the difference.
//    The JavaScript will be able to move and rearrange things.

// Perhaps have docking component separate?
//

// Multi-Layout-Mode-Document
//  Will have areas to display particular parts.
//  Will be convenient to have a tools menu that's somewhat separate from the main area, using the jsgui framework conventions.
