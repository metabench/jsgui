...
define(["../../jsgui-html", "./layout/top-and-bottom-bars", "../advanced/login", "../basic/link-menu"], 
	...
	var Admin_Home_Page = Client_HTML_Document.extend({
		...
		'init': function(spec) {
			...
			// include_jsgui_client

			// Not need to have any client-side JS file...?
			// It will need to activate the document.

			// I think some simple kind of client-side activation would make sense.
			//  All the info could be done through data attributes.

			// data-jsgui, then some data as JSON?
			//  id, type, spec

			// And type is the object / control type that gets created.
			//  Maybe with the controls we need to register the type names.
