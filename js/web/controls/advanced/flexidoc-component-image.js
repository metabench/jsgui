...
var Flexidoc_Component_Image = Flexidoc_Component.extend({
    ...
    'init': function(spec) {
        ...
        //this.set('dom.attributes.class', 'flexidoc-component-image');
        this.add_class('image');
        this.__type_name = 'flexidoc_component_image';
...
module.exports = Flexidoc_Component_Image;