...
server.start(port, function(ree, res_started) {
	...
	rt.set('/', function(req, res) {
		...
		//  Want to be able to set the size through the constructor.
		//   That will be an initial / automatic function call.
		//   Would it work as a field?
		...
		// Would a field make more sense as a Data_Value?

		//console.log('tof ctrl_0._.size ', tof(ctrl_0._.size));
		//console.log('ctrl_0._.size.value() ', ctrl_0._.size.value());
